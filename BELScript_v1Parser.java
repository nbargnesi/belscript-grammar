// $ANTLR 3.4 BELScript_v1.g 2012-08-07 11:00:57
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final BELScript_v1Parser.statement_return statement() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: obj, comment, obj_rel, obj_sub, obj_obj, rel, subject
    ...
    public static final BitSet FOLLOW_record_in_document335 = new BitSet(new long[]{0x0000214010040000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_EOF_in_document339 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_namespace_in_record375 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_annotation_in_record385 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_annotation_in_record395 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_document_in_record405 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_statement_group_in_record415 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_unset_statement_group_in_record425 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_unset_in_record435 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_statement_in_record445 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_doc_expr464 = new BitSet(new long[]{0x8000000100000000L});
    public static final BitSet FOLLOW_WS_in_set_doc_expr466 = new BitSet(new long[]{0x8000000100000000L});
    public static final BitSet FOLLOW_KWRD_DOCUMENT_in_set_doc_expr469 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_WS_in_set_doc_expr471 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_set_doc_expr_in_set_document491 = new BitSet(new long[]{0x0000040AAE000000L});
    public static final BitSet FOLLOW_document_property_in_set_document493 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_document495 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_set_document499 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_doc_expr_in_set_document528 = new BitSet(new long[]{0x0000040AAE000000L});
    public static final BitSet FOLLOW_document_property_in_set_document530 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_document532 = new BitSet(new long[]{0x4000000000000000L});
    public static final BitSet FOLLOW_VALUE_LIST_in_set_document536 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_doc_expr_in_set_document565 = new BitSet(new long[]{0x0000040AAE000000L});
    public static final BitSet FOLLOW_document_property_in_set_document567 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_document569 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_document573 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_sg_expr611 = new BitSet(new long[]{0x8000008000000000L});
    public static final BitSet FOLLOW_WS_in_set_sg_expr613 = new BitSet(new long[]{0x8000008000000000L});
    public static final BitSet FOLLOW_KWRD_STMT_GROUP_in_set_sg_expr616 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_sg_expr_in_set_statement_group635 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_statement_group637 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_set_statement_group641 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_sg_expr_in_set_statement_group660 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_statement_group662 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_statement_group666 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_annotation694 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation696 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_annotation698 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_set_annotation702 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_annotation731 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation733 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_annotation735 = new BitSet(new long[]{0x4000000000000000L});
    public static final BitSet FOLLOW_VALUE_LIST_in_set_annotation739 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_annotation768 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation770 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_annotation772 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation776 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_UNSET_in_unset_statement_group814 = new BitSet(new long[]{0x0000008000000000L});
    public static final BitSet FOLLOW_KWRD_STMT_GROUP_in_unset_statement_group816 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_UNSET_in_unset841 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_unset845 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_UNSET_in_unset864 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_IDENT_LIST_in_unset868 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_DEFINE_in_define_namespace896 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_KWRD_DFLT_in_define_namespace898 = new BitSet(new long[]{0x0000001000000000L});
    public static final BitSet FOLLOW_KWRD_NS_in_define_namespace900 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_namespace902 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_namespace904 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_KWRD_URL_in_define_namespace906 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_namespace908 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_DEFINE_in_define_namespace936 = new BitSet(new long[]{0x0000001000000000L});
    public static final BitSet FOLLOW_KWRD_NS_in_define_namespace938 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_namespace940 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_namespace942 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_KWRD_URL_in_define_namespace944 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_namespace946 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_DEFINE_in_define_anno_expr983 = new BitSet(new long[]{0x8000000000800000L});
    public static final BitSet FOLLOW_WS_in_define_anno_expr985 = new BitSet(new long[]{0x8000000000800000L});
    public static final BitSet FOLLOW_KWRD_ANNO_in_define_anno_expr988 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_WS_in_define_anno_expr990 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_define_anno_expr_in_define_annotation1010 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_annotation1012 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_annotation1014 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_KWRD_LIST_in_define_annotation1016 = new BitSet(new long[]{0x4000000000000000L});
    public static final BitSet FOLLOW_VALUE_LIST_in_define_annotation1020 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_anno_expr_in_define_annotation1049 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_annotation1051 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_annotation1053 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_KWRD_URL_in_define_annotation1055 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_annotation1059 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_anno_expr_in_define_annotation1088 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_annotation1090 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_annotation1092 = new BitSet(new long[]{0x0000002000000000L});
    public static final BitSet FOLLOW_KWRD_PATTERN_in_define_annotation1094 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_annotation1098 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_COMMA_in_argument1225 = new BitSet(new long[]{0x0000000000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_term_in_argument1228 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_COMMA_in_argument1242 = new BitSet(new long[]{0x0008800000000000L});
    public static final BitSet FOLLOW_param_in_argument1245 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_function_in_term1268 = new BitSet(new long[]{0x0000100000000000L});
    public static final BitSet FOLLOW_LP_in_term1270 = new BitSet(new long[]{0x0018800000000800L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_argument_in_term1273 = new BitSet(new long[]{0x0018800000000800L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_RP_in_term1277 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_term_in_statement1319 = new BitSet(new long[]{0x0080000000000002L,0x280607E064022C7FL,0x0000000000028402L});
    public static final BitSet FOLLOW_relationship_in_statement1324 = new BitSet(new long[]{0x0000100000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_LP_in_statement1327 = new BitSet(new long[]{0x0000000000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_term_in_statement1331 = new BitSet(new long[]{0x0000000000000000L,0x280607E064022C7FL,0x0000000000028402L});
    public static final BitSet FOLLOW_relationship_in_statement1335 = new BitSet(new long[]{0x0000000000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_term_in_statement1339 = new BitSet(new long[]{0x0010000000000000L});
    public static final BitSet FOLLOW_RP_in_statement1341 = new BitSet(new long[]{0x0080000000000002L});
    public static final BitSet FOLLOW_term_in_statement1347 = new BitSet(new long[]{0x0080000000000002L});
    public static final BitSet FOLLOW_STATEMENT_COMMENT_in_statement1354 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_ns_prefix1415 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_COLON_in_ns_prefix1417 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ns_prefix_in_param1437 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_param1440 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ns_prefix_in_param1461 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_param1464 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_126_in_function1500 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_115_in_function1524 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_134_in_function1563 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_128_in_function1591 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_72_in_function1630 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_71_in_function1661 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_111_in_function1700 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_110_in_function1723 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_98_in_function1762 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_97_in_function1789 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_76_in_function1828 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_78_in_function1851 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_117_in_function1889 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_116_in_function1920 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_87_in_function1956 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_86_in_function1980 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_146_in_function2013 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_141_in_function2040 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_82_in_function2076 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_136_in_function2103 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_83_in_function2140 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_140_in_function2159 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_131_in_function2195 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_135_in_function2227 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_89_in_function2264 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_88_in_function2286 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_96_in_function2317 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_95_in_function2351 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_92_in_function2388 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_91_in_function2417 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_112_in_function2454 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_73_in_function2477 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_80_in_function2514 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_79_in_function2537 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_108_in_function2574 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_107_in_function2600 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_121_in_function2637 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_120_in_function2658 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_119_in_function2694 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_118_in_function2717 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_133_in_function2754 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_132_in_function2774 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_144_in_function2810 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_150_in_function2827 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_147_in_function2860 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_142_in_function2883 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_100_in_function2918 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_99_in_function2942 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_85_in_function2979 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_84_in_function3002 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_127_in_function3038 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_122_in_function3059 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_139_in_function3095 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_137_in_function3123 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_149_in_function3160 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_148_in_function3190 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_130_in_function3225 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_124_in_function3256 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_109_in_function3288 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_105_in_relationship3337 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_65_in_relationship3368 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_90_in_relationship3406 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_66_in_relationship3437 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_94_in_relationship3475 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_68_in_relationship3498 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_93_in_relationship3536 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_69_in_relationship3559 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_81_in_relationship3597 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_123_in_relationship3623 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_113_in_relationship3644 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_145_in_relationship3665 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_70_in_relationship3693 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_143_in_relationship3731 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_67_in_relationship3758 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_106_in_relationship3796 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_138_in_relationship3833 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_129_in_relationship3861 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_77_in_relationship3883 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_125_in_relationship3911 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_114_in_relationship3929 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_74_in_relationship3958 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_75_in_relationship3989 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_64_in_relationship4018 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_104_in_relationship4056 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_102_in_relationship4086 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_103_in_relationship4113 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_101_in_relationship4144 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WS_in_eq_clause4179 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_EQ_in_eq_clause4182 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_WS_in_eq_clause4184 = new BitSet(new long[]{0x8000000000000002L});
