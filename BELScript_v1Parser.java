...
public class BELScript_v1Parser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ANNO_DEF_LIST", "ANNO_DEF_PTRN", "ANNO_DEF_URL", "ANNO_SET_ID", "ANNO_SET_LIST", "ANNO_SET_QV", "COLON", "COMMA", "DFLT_NSDEF", "DIGIT", "DOCDEF", "DOCSET_ID", "DOCSET_LIST", "DOCSET_QV", "DOCUMENT_COMMENT", "EQ", "ESCAPE_SEQUENCE", "HEX_DIGIT", "IDENT_LIST", "KWRD_ANNO", "KWRD_AS", "KWRD_AUTHORS", "KWRD_CONTACTINFO", "KWRD_COPYRIGHT", "KWRD_DEFINE", "KWRD_DESC", "KWRD_DFLT", "KWRD_DISCLAIMER", "KWRD_DOCUMENT", "KWRD_LICENSES", "KWRD_LIST", "KWRD_NAME", "KWRD_NS", "KWRD_PATTERN", "KWRD_SET", "KWRD_STMT_GROUP", "KWRD_UNSET", "KWRD_URL", "KWRD_VERSION", "LETTER", "LP", "NEWLINE", "NSDEF", "OBJECT_IDENT", "OCTAL_ESCAPE", "PARAM_DEF_ID", "PARAM_DEF_QV", "QUOTED_VALUE", "RP", "SG_SET_ID", "SG_SET_QV", "STATEMENT_COMMENT", "STMTDEF", "TERMDEF", "UNICODE_ESCAPE", "UNSET_ID", "UNSET_ID_LIST", "UNSET_SG", "VALUE_LIST", "WS", "'--'", "'->'", "'-|'", "':>'", "'=>'", "'=|'", "'>>'", "'a'", "'abundance'", "'act'", "'analogous'", "'association'", "'biologicalProcess'", "'biomarkerFor'", "'bp'", "'cat'", "'catalyticActivity'", "'causesNoChange'", "'cellSecretion'", "'cellSurfaceExpression'", "'chap'", "'chaperoneActivity'", "'complex'", "'complexAbundance'", "'composite'", "'compositeAbundance'", "'decreases'", "'deg'", "'degradation'", "'directlyDecreases'", "'directlyIncreases'", "'fus'", "'fusion'", "'g'", "'geneAbundance'", "'gtp'", "'gtpBoundActivity'", "'hasComponent'", "'hasComponents'", "'hasMember'", "'hasMembers'", "'increases'", "'isA'", "'kin'", "'kinaseActivity'", "'list'", "'m'", "'microRNAAbundance'", "'molecularActivity'", "'negativeCorrelation'", "'orthologous'", "'p'", "'path'", "'pathology'", "'pep'", "'peptidaseActivity'", "'phos'", "'phosphataseActivity'", "'pmod'", "'positiveCorrelation'", "'products'", "'prognosticBiomarkerFor'", "'proteinAbundance'", "'proteinModification'", "'r'", "'rateLimitingStepOf'", "'reactants'", "'reaction'", "'ribo'", "'ribosylationActivity'", "'rnaAbundance'", "'rxn'", "'sec'", "'sub'", "'subProcessOf'", "'substitution'", "'surf'", "'tloc'", "'tport'", "'transcribedTo'", "'transcriptionalActivity'", "'translatedTo'", "'translocation'", "'transportActivity'", "'trunc'", "'truncation'", "'tscript'"
    };
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public String[] getTokenNames() { return BELScript_v1Parser.tokenNames; }
    public String getGrammarFileName() { return "BELScript_v1.g"; }
    ...
    public final BELScript_v1Parser.document_return document() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_DOCUMENT_COMMENT=new RewriteRuleTokenStream(adaptor,"token DOCUMENT_COMMENT");
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    NEWLINE1=(Token)match(input,NEWLINE,FOLLOW_NEWLINE_in_document333);  
            	...
            	case 2 :
            	    ...
            	    {
            	    DOCUMENT_COMMENT2=(Token)match(input,DOCUMENT_COMMENT,FOLLOW_DOCUMENT_COMMENT_in_document337);  
    ...
    public final BELScript_v1Parser.record_return record() throws RecognitionException {
    ...
    public final BELScript_v1Parser.set_doc_expr_return set_doc_expr() throws RecognitionException {
        ...
        try {
            ...
            KWRD_SET13=(Token)match(input,KWRD_SET,FOLLOW_KWRD_SET_in_set_doc_expr470); 
            KWRD_SET13_tree = 
            ...
            do {
            	...
            	case 1 :
            	    // BELScript_v1.g:99:18: WS
            	    {
            	    WS14=(Token)match(input,WS,FOLLOW_WS_in_set_doc_expr472); 
            	    WS14_tree = 
            ...
            KWRD_DOCUMENT15=(Token)match(input,KWRD_DOCUMENT,FOLLOW_KWRD_DOCUMENT_in_set_doc_expr475); 
            ...
            do {
            	...
            	case 1 :
            	    // BELScript_v1.g:99:36: WS
            	    {
            	    WS16=(Token)match(input,WS,FOLLOW_WS_in_set_doc_expr477); 
            	    WS16_tree = 
    ...
    public final BELScript_v1Parser.set_document_return set_document() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_OBJECT_IDENT=new RewriteRuleTokenStream(adaptor,"token OBJECT_IDENT");
        RewriteRuleTokenStream stream_QUOTED_VALUE=new RewriteRuleTokenStream(adaptor,"token QUOTED_VALUE");
        RewriteRuleTokenStream stream_VALUE_LIST=new RewriteRuleTokenStream(adaptor,"token VALUE_LIST");
        RewriteRuleSubtreeStream stream_set_doc_expr=new RewriteRuleSubtreeStream(adaptor,"rule set_doc_expr");
        RewriteRuleSubtreeStream stream_eq_clause=new RewriteRuleSubtreeStream(adaptor,"rule eq_clause");
        RewriteRuleSubtreeStream stream_document_property=new RewriteRuleSubtreeStream(adaptor,"rule document_property");
        try {
            ...
            switch (alt5) {
                case 1 :
                    ...
                    val=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_set_document505);  
                    ...
                    // 103:67: -> ^( DOCSET_QV document_property $val)
                    {
                        ...
                        adaptor.addChild(root_1, stream_document_property.nextTree());
                ...
                case 2 :
                    ...
                    val=(Token)match(input,VALUE_LIST,FOLLOW_VALUE_LIST_in_set_document542);  
                    ...
                    // 105:65: -> ^( DOCSET_LIST document_property $val)
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(DOCSET_LIST, "DOCSET_LIST")
                        , root_1);
                ...
                case 3 :
                    ...
                    val=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_set_document579);  
    ...
    public final BELScript_v1Parser.set_sg_expr_return set_sg_expr() throws RecognitionException {
        ...
        try {
            ...
            KWRD_SET26=(Token)match(input,KWRD_SET,FOLLOW_KWRD_SET_in_set_sg_expr617); 
            KWRD_SET26_tree = 
            ...
            do {
            	...
            	case 1 :
            	    // BELScript_v1.g:112:18: WS
            	    {
            	    WS27=(Token)match(input,WS,FOLLOW_WS_in_set_sg_expr619); 
            	    WS27_tree = 
            ...
            KWRD_STMT_GROUP28=(Token)match(input,KWRD_STMT_GROUP,FOLLOW_KWRD_STMT_GROUP_in_set_sg_expr622); 
    ...
    public final BELScript_v1Parser.set_statement_group_return set_statement_group() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_QUOTED_VALUE=new RewriteRuleTokenStream(adaptor,"token QUOTED_VALUE");
        RewriteRuleSubtreeStream stream_eq_clause=new RewriteRuleSubtreeStream(adaptor,"rule eq_clause");
        RewriteRuleSubtreeStream stream_set_sg_expr=new RewriteRuleSubtreeStream(adaptor,"rule set_sg_expr");
        try {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    val=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_set_statement_group647);  
                    stream_QUOTED_VALUE.add(val);
                ...
                case 2 :
                    ...
                    val=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_set_statement_group672);  
                    stream_OBJECT_IDENT.add(val);
    ...
    public final BELScript_v1Parser.set_annotation_return set_annotation() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_QUOTED_VALUE=new RewriteRuleTokenStream(adaptor,"token QUOTED_VALUE");
        RewriteRuleTokenStream stream_VALUE_LIST=new RewriteRuleTokenStream(adaptor,"token VALUE_LIST");
        RewriteRuleTokenStream stream_KWRD_SET=new RewriteRuleTokenStream(adaptor,"token KWRD_SET");
        RewriteRuleSubtreeStream stream_eq_clause=new RewriteRuleSubtreeStream(adaptor,"rule eq_clause");
        try {
            ...
            switch (alt8) {
                case 1 :
                    ...
                    {
                    KWRD_SET33=(Token)match(input,KWRD_SET,FOLLOW_KWRD_SET_in_set_annotation700);  
                    stream_KWRD_SET.add(KWRD_SET33);


                    OBJECT_IDENT34=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_set_annotation702);  
                    ...
                    val=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_set_annotation708);  
                    stream_QUOTED_VALUE.add(val);
                ...
                case 2 :
                    ...
                    {
                    KWRD_SET36=(Token)match(input,KWRD_SET,FOLLOW_KWRD_SET_in_set_annotation737);  
                    stream_KWRD_SET.add(KWRD_SET36);


                    OBJECT_IDENT37=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_set_annotation739);  
                    ...
                    val=(Token)match(input,VALUE_LIST,FOLLOW_VALUE_LIST_in_set_annotation745);  
                    stream_VALUE_LIST.add(val);
                ...
                case 3 :
                    ...
                    {
                    KWRD_SET39=(Token)match(input,KWRD_SET,FOLLOW_KWRD_SET_in_set_annotation774);  
                    stream_KWRD_SET.add(KWRD_SET39);


                    OBJECT_IDENT40=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_set_annotation776);  
                    ...
                    val=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_set_annotation782);  
                    stream_OBJECT_IDENT.add(val);
    ...
    public final BELScript_v1Parser.unset_statement_group_return unset_statement_group() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_KWRD_UNSET=new RewriteRuleTokenStream(adaptor,"token KWRD_UNSET");
        RewriteRuleTokenStream stream_KWRD_STMT_GROUP=new RewriteRuleTokenStream(adaptor,"token KWRD_STMT_GROUP");

        try {
            // BELScript_v1.g:130:5: ( KWRD_UNSET KWRD_STMT_GROUP -> ^( UNSET_SG ) )
            // BELScript_v1.g:130:9: KWRD_UNSET KWRD_STMT_GROUP
            {
            KWRD_UNSET42=(Token)match(input,KWRD_UNSET,FOLLOW_KWRD_UNSET_in_unset_statement_group820);  
            stream_KWRD_UNSET.add(KWRD_UNSET42);


            KWRD_STMT_GROUP43=(Token)match(input,KWRD_STMT_GROUP,FOLLOW_KWRD_STMT_GROUP_in_unset_statement_group822);  
    ...
    public final BELScript_v1Parser.unset_return unset() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_OBJECT_IDENT=new RewriteRuleTokenStream(adaptor,"token OBJECT_IDENT");
        RewriteRuleTokenStream stream_KWRD_UNSET=new RewriteRuleTokenStream(adaptor,"token KWRD_UNSET");
        RewriteRuleTokenStream stream_IDENT_LIST=new RewriteRuleTokenStream(adaptor,"token IDENT_LIST");
        ...
        try {
            ...
            switch (alt9) {
                case 1 :
                    ...
                    {
                    KWRD_UNSET44=(Token)match(input,KWRD_UNSET,FOLLOW_KWRD_UNSET_in_unset847);  
                    stream_KWRD_UNSET.add(KWRD_UNSET44);


                    val=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_unset851);  
                    stream_OBJECT_IDENT.add(val);
                ...
                case 2 :
                    ...
                    {
                    KWRD_UNSET45=(Token)match(input,KWRD_UNSET,FOLLOW_KWRD_UNSET_in_unset870);  
                    stream_KWRD_UNSET.add(KWRD_UNSET45);


                    val=(Token)match(input,IDENT_LIST,FOLLOW_IDENT_LIST_in_unset874);  
                    ...
                    // 135:35: -> ^( UNSET_ID_LIST $val)
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(UNSET_ID_LIST, "UNSET_ID_LIST")
                        , root_1);
    ...
    public final BELScript_v1Parser.define_namespace_return define_namespace() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_KWRD_DFLT=new RewriteRuleTokenStream(adaptor,"token KWRD_DFLT");
        RewriteRuleTokenStream stream_KWRD_DEFINE=new RewriteRuleTokenStream(adaptor,"token KWRD_DEFINE");
        RewriteRuleTokenStream stream_OBJECT_IDENT=new RewriteRuleTokenStream(adaptor,"token OBJECT_IDENT");
        RewriteRuleTokenStream stream_QUOTED_VALUE=new RewriteRuleTokenStream(adaptor,"token QUOTED_VALUE");
        RewriteRuleTokenStream stream_KWRD_NS=new RewriteRuleTokenStream(adaptor,"token KWRD_NS");
        RewriteRuleTokenStream stream_KWRD_URL=new RewriteRuleTokenStream(adaptor,"token KWRD_URL");
        RewriteRuleTokenStream stream_KWRD_AS=new RewriteRuleTokenStream(adaptor,"token KWRD_AS");
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    {
                    KWRD_DEFINE46=(Token)match(input,KWRD_DEFINE,FOLLOW_KWRD_DEFINE_in_define_namespace902);  
                    stream_KWRD_DEFINE.add(KWRD_DEFINE46);


                    KWRD_DFLT47=(Token)match(input,KWRD_DFLT,FOLLOW_KWRD_DFLT_in_define_namespace904);  
                    stream_KWRD_DFLT.add(KWRD_DFLT47);


                    KWRD_NS48=(Token)match(input,KWRD_NS,FOLLOW_KWRD_NS_in_define_namespace906);  
                    stream_KWRD_NS.add(KWRD_NS48);


                    OBJECT_IDENT49=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_define_namespace908);  
                    stream_OBJECT_IDENT.add(OBJECT_IDENT49);


                    KWRD_AS50=(Token)match(input,KWRD_AS,FOLLOW_KWRD_AS_in_define_namespace910);  
                    stream_KWRD_AS.add(KWRD_AS50);


                    KWRD_URL51=(Token)match(input,KWRD_URL,FOLLOW_KWRD_URL_in_define_namespace912);  
                    stream_KWRD_URL.add(KWRD_URL51);


                    QUOTED_VALUE52=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_define_namespace914);  
                ...
                case 2 :
                    ...
                    {
                    KWRD_DEFINE53=(Token)match(input,KWRD_DEFINE,FOLLOW_KWRD_DEFINE_in_define_namespace942);  
                    stream_KWRD_DEFINE.add(KWRD_DEFINE53);


                    KWRD_NS54=(Token)match(input,KWRD_NS,FOLLOW_KWRD_NS_in_define_namespace944);  
                    stream_KWRD_NS.add(KWRD_NS54);


                    OBJECT_IDENT55=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_define_namespace946);  
                    stream_OBJECT_IDENT.add(OBJECT_IDENT55);


                    KWRD_AS56=(Token)match(input,KWRD_AS,FOLLOW_KWRD_AS_in_define_namespace948);  
                    stream_KWRD_AS.add(KWRD_AS56);


                    KWRD_URL57=(Token)match(input,KWRD_URL,FOLLOW_KWRD_URL_in_define_namespace950);  
                    stream_KWRD_URL.add(KWRD_URL57);


                    QUOTED_VALUE58=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_define_namespace952);  
    ...
    public final BELScript_v1Parser.define_anno_expr_return define_anno_expr() throws RecognitionException {
        ...
        try {
            ...
            KWRD_DEFINE59=(Token)match(input,KWRD_DEFINE,FOLLOW_KWRD_DEFINE_in_define_anno_expr989); 
            KWRD_DEFINE59_tree = 
            ...
            do {
            	...
            	case 1 :
            	    // BELScript_v1.g:146:21: WS
            	    {
            	    WS60=(Token)match(input,WS,FOLLOW_WS_in_define_anno_expr991); 
            	    WS60_tree = 
            ...
            KWRD_ANNO61=(Token)match(input,KWRD_ANNO,FOLLOW_KWRD_ANNO_in_define_anno_expr994); 
            KWRD_ANNO61_tree = 
            ...
            do {
            	...
            	case 1 :
            	    // BELScript_v1.g:146:35: WS
            	    {
            	    WS62=(Token)match(input,WS,FOLLOW_WS_in_define_anno_expr996); 
            	    WS62_tree = 
    ...
    public final BELScript_v1Parser.define_annotation_return define_annotation() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_OBJECT_IDENT=new RewriteRuleTokenStream(adaptor,"token OBJECT_IDENT");
        RewriteRuleTokenStream stream_KWRD_LIST=new RewriteRuleTokenStream(adaptor,"token KWRD_LIST");
        RewriteRuleTokenStream stream_KWRD_PATTERN=new RewriteRuleTokenStream(adaptor,"token KWRD_PATTERN");
        RewriteRuleTokenStream stream_QUOTED_VALUE=new RewriteRuleTokenStream(adaptor,"token QUOTED_VALUE");
        RewriteRuleTokenStream stream_KWRD_URL=new RewriteRuleTokenStream(adaptor,"token KWRD_URL");
        RewriteRuleTokenStream stream_KWRD_AS=new RewriteRuleTokenStream(adaptor,"token KWRD_AS");
        RewriteRuleTokenStream stream_VALUE_LIST=new RewriteRuleTokenStream(adaptor,"token VALUE_LIST");
        RewriteRuleSubtreeStream stream_define_anno_expr=new RewriteRuleSubtreeStream(adaptor,"rule define_anno_expr");
        try {
            ...
            switch (alt13) {
                case 1 :
                    ...
                    OBJECT_IDENT64=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_define_annotation1018);  
                    stream_OBJECT_IDENT.add(OBJECT_IDENT64);


                    KWRD_AS65=(Token)match(input,KWRD_AS,FOLLOW_KWRD_AS_in_define_annotation1020);  
                    stream_KWRD_AS.add(KWRD_AS65);


                    KWRD_LIST66=(Token)match(input,KWRD_LIST,FOLLOW_KWRD_LIST_in_define_annotation1022);  
                    stream_KWRD_LIST.add(KWRD_LIST66);


                    val=(Token)match(input,VALUE_LIST,FOLLOW_VALUE_LIST_in_define_annotation1026);  
                    stream_VALUE_LIST.add(val);
                ...
                case 2 :
                    ...
                    OBJECT_IDENT68=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_define_annotation1057);  
                    stream_OBJECT_IDENT.add(OBJECT_IDENT68);


                    KWRD_AS69=(Token)match(input,KWRD_AS,FOLLOW_KWRD_AS_in_define_annotation1059);  
                    stream_KWRD_AS.add(KWRD_AS69);


                    KWRD_URL70=(Token)match(input,KWRD_URL,FOLLOW_KWRD_URL_in_define_annotation1061);  
                    stream_KWRD_URL.add(KWRD_URL70);


                    val=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_define_annotation1065);  
                    stream_QUOTED_VALUE.add(val);
                ...
                case 3 :
                    ...
                    OBJECT_IDENT72=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_define_annotation1096);  
                    stream_OBJECT_IDENT.add(OBJECT_IDENT72);


                    KWRD_AS73=(Token)match(input,KWRD_AS,FOLLOW_KWRD_AS_in_define_annotation1098);  
                    stream_KWRD_AS.add(KWRD_AS73);


                    KWRD_PATTERN74=(Token)match(input,KWRD_PATTERN,FOLLOW_KWRD_PATTERN_in_define_annotation1100);  
                    stream_KWRD_PATTERN.add(KWRD_PATTERN74);


                    val=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_define_annotation1104);  
                    stream_QUOTED_VALUE.add(val);
    ...
    public final BELScript_v1Parser.document_property_return document_property() throws RecognitionException {
    ...
    public final BELScript_v1Parser.argument_return argument() throws RecognitionException {
        ...
        try {
            ...
            case COMMA:
                ...
                if ( ((LA16_1 >= 71 && LA16_1 <= 73)||LA16_1==76||(LA16_1 >= 78 && LA16_1 <= 80)||(LA16_1 >= 82 && LA16_1 <= 89)||(LA16_1 >= 91 && LA16_1 <= 92)||(LA16_1 >= 95 && LA16_1 <= 100)||(LA16_1 >= 107 && LA16_1 <= 112)||(LA16_1 >= 115 && LA16_1 <= 122)||LA16_1==124||(LA16_1 >= 126 && LA16_1 <= 128)||(LA16_1 >= 130 && LA16_1 <= 137)||(LA16_1 >= 139 && LA16_1 <= 142)||LA16_1==144||(LA16_1 >= 146 && LA16_1 <= 150)) ) {
                    alt16=1;
                }
                ...
                case 1 :
                    ...
                    switch (alt14) {
                        case 1 :
                            // BELScript_v1.g:170:9: COMMA
                            {
                            COMMA76=(Token)match(input,COMMA,FOLLOW_COMMA_in_argument1231);  
                ...
                case 2 :
                    ...
                    switch (alt15) {
                        case 1 :
                            // BELScript_v1.g:171:9: COMMA
                            {
                            COMMA78=(Token)match(input,COMMA,FOLLOW_COMMA_in_argument1248);  
    ...
    public final BELScript_v1Parser.term_return term() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( (LA17_0==COMMA||LA17_0==OBJECT_IDENT||LA17_0==QUOTED_VALUE||(LA17_0 >= 71 && LA17_0 <= 73)||LA17_0==76||(LA17_0 >= 78 && LA17_0 <= 80)||(LA17_0 >= 82 && LA17_0 <= 89)||(LA17_0 >= 91 && LA17_0 <= 92)||(LA17_0 >= 95 && LA17_0 <= 100)||(LA17_0 >= 107 && LA17_0 <= 112)||(LA17_0 >= 115 && LA17_0 <= 122)||LA17_0==124||(LA17_0 >= 126 && LA17_0 <= 128)||(LA17_0 >= 130 && LA17_0 <= 137)||(LA17_0 >= 139 && LA17_0 <= 142)||LA17_0==144||(LA17_0 >= 146 && LA17_0 <= 150)) ) {
                    alt17=1;
                }
    ...
    public final BELScript_v1Parser.statement_return statement() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_RP=new RewriteRuleTokenStream(adaptor,"token RP");
        RewriteRuleTokenStream stream_STATEMENT_COMMENT=new RewriteRuleTokenStream(adaptor,"token STATEMENT_COMMENT");
        RewriteRuleTokenStream stream_LP=new RewriteRuleTokenStream(adaptor,"token LP");
        RewriteRuleSubtreeStream stream_relationship=new RewriteRuleSubtreeStream(adaptor,"rule relationship");
        RewriteRuleSubtreeStream stream_term=new RewriteRuleSubtreeStream(adaptor,"rule term");
        try {
            ...
            if ( ((LA19_0 >= 64 && LA19_0 <= 70)||(LA19_0 >= 74 && LA19_0 <= 75)||LA19_0==77||LA19_0==81||LA19_0==90||(LA19_0 >= 93 && LA19_0 <= 94)||(LA19_0 >= 101 && LA19_0 <= 106)||(LA19_0 >= 113 && LA19_0 <= 114)||LA19_0==123||LA19_0==125||LA19_0==129||LA19_0==138||LA19_0==143||LA19_0==145) ) {
                alt19=1;
            }
            switch (alt19) {
                case 1 :
                    ...
                    else if ( ((LA18_0 >= 71 && LA18_0 <= 73)||LA18_0==76||(LA18_0 >= 78 && LA18_0 <= 80)||(LA18_0 >= 82 && LA18_0 <= 89)||(LA18_0 >= 91 && LA18_0 <= 92)||(LA18_0 >= 95 && LA18_0 <= 100)||(LA18_0 >= 107 && LA18_0 <= 112)||(LA18_0 >= 115 && LA18_0 <= 122)||LA18_0==124||(LA18_0 >= 126 && LA18_0 <= 128)||(LA18_0 >= 130 && LA18_0 <= 137)||(LA18_0 >= 139 && LA18_0 <= 142)||LA18_0==144||(LA18_0 >= 146 && LA18_0 <= 150)) ) {
                        alt18=2;
                    }
                    else {
                        NoViableAltException nvae =
                    ...
                    switch (alt18) {
                        case 1 :
                            ...
                            {
                            LP84=(Token)match(input,LP,FOLLOW_LP_in_statement1333);  
                            stream_LP.add(LP84);
                            ...
                            RP85=(Token)match(input,RP,FOLLOW_RP_in_statement1347);  
                            stream_RP.add(RP85);
            ...
            switch (alt20) {
                case 1 :
                    // BELScript_v1.g:182:115: comment= STATEMENT_COMMENT
                    {
                    comment=(Token)match(input,STATEMENT_COMMENT,FOLLOW_STATEMENT_COMMENT_in_statement1360);  
            ...
            RewriteRuleSubtreeStream stream_retval=new RewriteRuleSubtreeStream(adaptor,"rule retval",retval!=null?retval.tree:null);
            RewriteRuleSubtreeStream stream_obj_sub=new RewriteRuleSubtreeStream(adaptor,"rule obj_sub",obj_sub!=null?obj_sub.tree:null);
            ...
            RewriteRuleSubtreeStream stream_obj_rel=new RewriteRuleSubtreeStream(adaptor,"rule obj_rel",obj_rel!=null?obj_rel.tree:null);
    ...
    public final BELScript_v1Parser.ns_prefix_return ns_prefix() throws RecognitionException {
        ...
        try {
            ...
            OBJECT_IDENT86=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_ns_prefix1421); 
            OBJECT_IDENT86_tree = 
            ...
            COLON87=(Token)match(input,COLON,FOLLOW_COLON_in_ns_prefix1423); 
    ...
    public final BELScript_v1Parser.param_return param() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_OBJECT_IDENT=new RewriteRuleTokenStream(adaptor,"token OBJECT_IDENT");
        RewriteRuleTokenStream stream_QUOTED_VALUE=new RewriteRuleTokenStream(adaptor,"token QUOTED_VALUE");
        RewriteRuleSubtreeStream stream_ns_prefix=new RewriteRuleSubtreeStream(adaptor,"rule ns_prefix");
        try {
            ...
            if ( (LA23_0==OBJECT_IDENT) ) {
                ...
                else if ( (LA23_1==COMMA||LA23_1==OBJECT_IDENT||(LA23_1 >= QUOTED_VALUE && LA23_1 <= RP)||(LA23_1 >= 71 && LA23_1 <= 73)||LA23_1==76||(LA23_1 >= 78 && LA23_1 <= 80)||(LA23_1 >= 82 && LA23_1 <= 89)||(LA23_1 >= 91 && LA23_1 <= 92)||(LA23_1 >= 95 && LA23_1 <= 100)||(LA23_1 >= 107 && LA23_1 <= 112)||(LA23_1 >= 115 && LA23_1 <= 122)||LA23_1==124||(LA23_1 >= 126 && LA23_1 <= 128)||(LA23_1 >= 130 && LA23_1 <= 137)||(LA23_1 >= 139 && LA23_1 <= 142)||LA23_1==144||(LA23_1 >= 146 && LA23_1 <= 150)) ) {
                    alt23=1;
                }
                else {
                    NoViableAltException nvae =
            ...
            switch (alt23) {
                case 1 :
                    ...
                    OBJECT_IDENT89=(Token)match(input,OBJECT_IDENT,FOLLOW_OBJECT_IDENT_in_param1446);  
                    ...
                    // 191:33: -> ^( PARAM_DEF_ID ( ns_prefix )? OBJECT_IDENT )
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(PARAM_DEF_ID, "PARAM_DEF_ID")
                        , root_1);

                        // BELScript_v1.g:191:51: ( ns_prefix )?
                        if ( stream_ns_prefix.hasNext() ) {
                            adaptor.addChild(root_1, stream_ns_prefix.nextTree());
                ...
                case 2 :
                    ...
                    QUOTED_VALUE91=(Token)match(input,QUOTED_VALUE,FOLLOW_QUOTED_VALUE_in_param1470);  
                    ...
                    // 192:33: -> ^( PARAM_DEF_QV ( ns_prefix )? QUOTED_VALUE )
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(PARAM_DEF_QV, "PARAM_DEF_QV")
                        , root_1);
    ...
    public final BELScript_v1Parser.function_return function() throws RecognitionException {
    ...
    public final BELScript_v1Parser.relationship_return relationship() throws RecognitionException {
    ...
    public final BELScript_v1Parser.eq_clause_return eq_clause() throws RecognitionException {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    // BELScript_v1.g:289:9: WS
            	    {
            	    WS92=(Token)match(input,WS,FOLLOW_WS_in_eq_clause4185); 
            	    WS92_tree = 
            ...
            do {
            	...
            	case 1 :
            	    // BELScript_v1.g:289:16: WS
            	    {
            	    WS94=(Token)match(input,WS,FOLLOW_WS_in_eq_clause4190); 
            	    WS94_tree = 
    ...
    public static final BitSet FOLLOW_NEWLINE_in_document333 = new BitSet(new long[]{0x0000214010040000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_DOCUMENT_COMMENT_in_document337 = new BitSet(new long[]{0x0000214010040000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_record_in_document341 = new BitSet(new long[]{0x0000214010040000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_EOF_in_document345 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_namespace_in_record381 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_annotation_in_record391 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_annotation_in_record401 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_document_in_record411 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_statement_group_in_record421 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_unset_statement_group_in_record431 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_unset_in_record441 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_statement_in_record451 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_doc_expr470 = new BitSet(new long[]{0x8000000100000000L});
    public static final BitSet FOLLOW_WS_in_set_doc_expr472 = new BitSet(new long[]{0x8000000100000000L});
    public static final BitSet FOLLOW_KWRD_DOCUMENT_in_set_doc_expr475 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_WS_in_set_doc_expr477 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_set_doc_expr_in_set_document497 = new BitSet(new long[]{0x0000040AAE000000L});
    public static final BitSet FOLLOW_document_property_in_set_document499 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_document501 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_set_document505 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_doc_expr_in_set_document534 = new BitSet(new long[]{0x0000040AAE000000L});
    public static final BitSet FOLLOW_document_property_in_set_document536 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_document538 = new BitSet(new long[]{0x4000000000000000L});
    public static final BitSet FOLLOW_VALUE_LIST_in_set_document542 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_doc_expr_in_set_document571 = new BitSet(new long[]{0x0000040AAE000000L});
    public static final BitSet FOLLOW_document_property_in_set_document573 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_document575 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_document579 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_sg_expr617 = new BitSet(new long[]{0x8000008000000000L});
    public static final BitSet FOLLOW_WS_in_set_sg_expr619 = new BitSet(new long[]{0x8000008000000000L});
    public static final BitSet FOLLOW_KWRD_STMT_GROUP_in_set_sg_expr622 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_sg_expr_in_set_statement_group641 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_statement_group643 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_set_statement_group647 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_sg_expr_in_set_statement_group666 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_statement_group668 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_statement_group672 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_annotation700 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation702 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_annotation704 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_set_annotation708 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_annotation737 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation739 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_annotation741 = new BitSet(new long[]{0x4000000000000000L});
    public static final BitSet FOLLOW_VALUE_LIST_in_set_annotation745 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_SET_in_set_annotation774 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation776 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_eq_clause_in_set_annotation778 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_set_annotation782 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_UNSET_in_unset_statement_group820 = new BitSet(new long[]{0x0000008000000000L});
    public static final BitSet FOLLOW_KWRD_STMT_GROUP_in_unset_statement_group822 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_UNSET_in_unset847 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_unset851 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_UNSET_in_unset870 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_IDENT_LIST_in_unset874 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_DEFINE_in_define_namespace902 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_KWRD_DFLT_in_define_namespace904 = new BitSet(new long[]{0x0000001000000000L});
    public static final BitSet FOLLOW_KWRD_NS_in_define_namespace906 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_namespace908 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_namespace910 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_KWRD_URL_in_define_namespace912 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_namespace914 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_DEFINE_in_define_namespace942 = new BitSet(new long[]{0x0000001000000000L});
    public static final BitSet FOLLOW_KWRD_NS_in_define_namespace944 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_namespace946 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_namespace948 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_KWRD_URL_in_define_namespace950 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_namespace952 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_KWRD_DEFINE_in_define_anno_expr989 = new BitSet(new long[]{0x8000000000800000L});
    public static final BitSet FOLLOW_WS_in_define_anno_expr991 = new BitSet(new long[]{0x8000000000800000L});
    public static final BitSet FOLLOW_KWRD_ANNO_in_define_anno_expr994 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_WS_in_define_anno_expr996 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_define_anno_expr_in_define_annotation1016 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_annotation1018 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_annotation1020 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_KWRD_LIST_in_define_annotation1022 = new BitSet(new long[]{0x4000000000000000L});
    public static final BitSet FOLLOW_VALUE_LIST_in_define_annotation1026 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_anno_expr_in_define_annotation1055 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_annotation1057 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_annotation1059 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_KWRD_URL_in_define_annotation1061 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_annotation1065 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_define_anno_expr_in_define_annotation1094 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_define_annotation1096 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_KWRD_AS_in_define_annotation1098 = new BitSet(new long[]{0x0000002000000000L});
    public static final BitSet FOLLOW_KWRD_PATTERN_in_define_annotation1100 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_define_annotation1104 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_COMMA_in_argument1231 = new BitSet(new long[]{0x0000000000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_term_in_argument1234 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_COMMA_in_argument1248 = new BitSet(new long[]{0x0008800000000000L});
    public static final BitSet FOLLOW_param_in_argument1251 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_function_in_term1274 = new BitSet(new long[]{0x0000100000000000L});
    public static final BitSet FOLLOW_LP_in_term1276 = new BitSet(new long[]{0x0018800000000800L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_argument_in_term1279 = new BitSet(new long[]{0x0018800000000800L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_RP_in_term1283 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_term_in_statement1325 = new BitSet(new long[]{0x0080000000000002L,0x280607E064022C7FL,0x0000000000028402L});
    public static final BitSet FOLLOW_relationship_in_statement1330 = new BitSet(new long[]{0x0000100000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_LP_in_statement1333 = new BitSet(new long[]{0x0000000000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_term_in_statement1337 = new BitSet(new long[]{0x0000000000000000L,0x280607E064022C7FL,0x0000000000028402L});
    public static final BitSet FOLLOW_relationship_in_statement1341 = new BitSet(new long[]{0x0000000000000000L,0xD7F9F81F9BFDD380L,0x00000000007D7BFDL});
    public static final BitSet FOLLOW_term_in_statement1345 = new BitSet(new long[]{0x0010000000000000L});
    public static final BitSet FOLLOW_RP_in_statement1347 = new BitSet(new long[]{0x0080000000000002L});
    public static final BitSet FOLLOW_term_in_statement1353 = new BitSet(new long[]{0x0080000000000002L});
    public static final BitSet FOLLOW_STATEMENT_COMMENT_in_statement1360 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_ns_prefix1421 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_COLON_in_ns_prefix1423 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ns_prefix_in_param1443 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_OBJECT_IDENT_in_param1446 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ns_prefix_in_param1467 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_QUOTED_VALUE_in_param1470 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_126_in_function1506 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_115_in_function1530 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_134_in_function1569 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_128_in_function1597 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_72_in_function1636 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_71_in_function1667 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_111_in_function1706 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_110_in_function1729 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_98_in_function1768 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_97_in_function1795 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_76_in_function1834 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_78_in_function1857 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_117_in_function1895 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_116_in_function1926 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_87_in_function1962 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_86_in_function1986 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_146_in_function2019 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_141_in_function2046 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_82_in_function2082 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_136_in_function2109 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_83_in_function2146 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_140_in_function2165 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_131_in_function2201 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_135_in_function2233 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_89_in_function2270 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_88_in_function2292 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_96_in_function2323 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_95_in_function2357 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_92_in_function2394 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_91_in_function2423 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_112_in_function2460 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_73_in_function2483 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_80_in_function2520 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_79_in_function2543 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_108_in_function2580 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_107_in_function2606 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_121_in_function2643 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_120_in_function2664 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_119_in_function2700 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_118_in_function2723 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_133_in_function2760 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_132_in_function2780 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_144_in_function2816 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_150_in_function2833 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_147_in_function2866 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_142_in_function2889 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_100_in_function2924 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_99_in_function2948 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_85_in_function2985 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_84_in_function3008 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_127_in_function3044 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_122_in_function3065 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_139_in_function3101 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_137_in_function3129 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_149_in_function3166 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_148_in_function3196 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_130_in_function3231 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_124_in_function3262 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_109_in_function3294 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_105_in_relationship3343 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_65_in_relationship3374 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_90_in_relationship3412 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_66_in_relationship3443 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_94_in_relationship3481 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_68_in_relationship3504 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_93_in_relationship3542 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_69_in_relationship3565 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_81_in_relationship3603 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_123_in_relationship3629 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_113_in_relationship3650 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_145_in_relationship3671 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_70_in_relationship3699 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_143_in_relationship3737 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_67_in_relationship3764 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_106_in_relationship3802 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_138_in_relationship3839 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_129_in_relationship3867 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_77_in_relationship3889 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_125_in_relationship3917 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_114_in_relationship3935 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_74_in_relationship3964 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_75_in_relationship3995 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_64_in_relationship4024 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_104_in_relationship4062 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_102_in_relationship4092 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_103_in_relationship4119 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_101_in_relationship4150 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WS_in_eq_clause4185 = new BitSet(new long[]{0x8000000000080000L});
    public static final BitSet FOLLOW_EQ_in_eq_clause4188 = new BitSet(new long[]{0x8000000000000002L});
    public static final BitSet FOLLOW_WS_in_eq_clause4190 = new BitSet(new long[]{0x8000000000000002L});
